        ...
        {filteredProducts.length === 0 ? (
          <div className="bg-black/5 border border-current/10 rounded-3xl p-12 text-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-black shadow-lg shadow-blue-500/25 text-xs px-4 py-2 rounded-xl"
            >
              إعادة تعيين البحث
            </button>
          </div>
