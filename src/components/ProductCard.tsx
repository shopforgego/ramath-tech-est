...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="group bg-[#0f172a] border border-blue-950 hover:border-blue-500/60 shadow-lg hover:shadow-blue-500/10 rounded-2xl overflow-hidden transition-all duration-300 flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          <span className="text-[11px] text-blue-400 font-bold mb-1 block">{product.category}</span>
          <h3
        ...
        <div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-black shadow-lg shadow-blue-500/25 py-2.5 px-3 rounded-xl transition text-xs font-bold"
          >
